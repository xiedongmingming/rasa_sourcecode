...
class RasaFileImporter(TrainingDataImporter):
    ...
    def __init__(
            self,
            config_file: Optional[Text] = None,  # 'config.yml'
            domain_path: Optional[Text] = None,  # 'domain.yml'
            training_data_paths: Optional[Union[List[Text], Text]] = None,  # ['data']
    ):

        self._domain_path = domain_path

        self._nlu_files = rasa.shared.data.get_data_files(  # ['data\\nlu.yml', 'data\\responses.yml']
